    ...
    <div className="App">
      ...
      <div className='modal-container'>
        ...
        {open && (<div className='overlay'>
          <div className='modal'>
            <img src="./bugatti.jpg" width={300} alt="Bugatti" />
            <svg className='cross-button' width="50px" height="50px" viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
